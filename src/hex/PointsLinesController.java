...
import exceptions.pointsNotClose;

public class PointsLinesController {
    protected static void connectPoints(HexPoint leftPoint, HexPoint rightPoint, HexLine line) {
    ...
    protected static void connectLinePoint(HexLine line, HexPoint point) {
        point.addLine(line);
        line.addPoint(point);
    }
