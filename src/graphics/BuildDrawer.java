...
import hex.City;
import hex.Road;
import hex.Settlement;

import java.awt.Graphics2D;
import java.awt.Color;

public class BuildDrawer {
    public static void drawSettlement(Graphics2D g2d, Settlement settlement, int x, int y) {
    ...
    public static void drawCity(Graphics2D g2d, City city, int x, int y) {
    ...
    public static void drawRoadRightDown(Graphics2D g2d, Road road, int upperPointX, int upperPointY) {
...
//        g2d.drawLine(upperPointX + 13, upperPointY + 14, upperPointX + 18, upperPointY + 1);
    ...
    public static void drawRoadLeftDown(Graphics2D g2d, Road road, int upperPointX, int upperPointY) {
...
//        g2d.drawLine(upperPointX - 52, upperPointY + 18, upperPointX - 18, upperPointY + 1);
    ...
    public static void drawRoadUpDown(Graphics2D g2d, Road road, int upperPointX, int upperPointY) {
//        g2d.drawLine(upperPointX -7, upperPointY + 17, upperPointX +7, upperPointY + 17);
//        g2d.drawLine(upperPointX +7, upperPointY + 17, upperPointX +7, upperPointY + 57);
//        g2d.drawLine(upperPointX +7, upperPointY + 57, upperPointX -7, upperPointY + 57);
//        g2d.drawLine(upperPointX -7, upperPointY + 57, upperPointX -7, upperPointY + 17);
        int[] xPoints = new int[4];
