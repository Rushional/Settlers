...
public class ResourcesSet {
    ...
    public static ResourcesSet subtractSet(ResourcesSet reduced, ResourcesSet subtracted) {
        ...
        ResourcesSet difference = new ResourcesSet(reduced.wood-subtracted.wood, reduced.bricks-subtracted.bricks, reduced.sheep-subtracted.sheep, reduced.wheat-subtracted.wheat, reduced.ore-subtracted.ore);;
        return difference;
    }
