...
// but by the time I`m finished those polygons are long gone, and the drawings consists of entirely new Polygons.
// And well, it shouldn't matter, because coordinates don't change. But instead of trying to calculate
// my stuff with dated polygons, I decided to make CALCUGONS. These are awt polygons used for calculations and not drawing.
