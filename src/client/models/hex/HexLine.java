...
import client.exceptions.connectionsArrayFull;
import client.exceptions.opponentsCityOnWay;
import client.exceptions.opponentsSettlementOnWay;
import client.exceptions.roadHasNoAccess;
...
//        hasRoad = true;
    ...
    private void validateRoadHasAccess(Player player) throws opponentsCityOnWay, opponentsSettlementOnWay, roadHasNoAccess {
        ...
        if (points[0].hasBuilding()) {
            ...
            //Make sure otherLines[1] isn't null - it could be on game_model.map edges!
